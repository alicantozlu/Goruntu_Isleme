...
class Camouflage():
    ...
    def __init__(self, imageName, colorRange):
    ...
    def saveMaskedImage(self):
        masked_image_name = "yeni-" + self.image_name
        project_dir = os.path.dirname(os.path.abspath(__file__))
...
if (__name__ == "__main__"):
    Camouflage("Car.jpg", 150)
    Camouflage("kalem.jpg", 110)
    Camouflage("mouse.jpg", 120)
    Camouflage("Osman.jpg", 210)
